...
//验证投注的号码是否正确
func (pls *PlayFc3d) PlayCheck() bool {
...
//直选单式
//格式为 1,2,3
func (pls *PlayFc3d) zhixuanSingle() bool {
...
//直选复试
//格式为：1 2,2 3,3 4
func (pls *PlayFc3d) zhixuanComplex() bool {
	if strings.Count(pls.numLottery.LotNum, ";") != 2 {
		return false
	}
...
//直选和值
//格式为：05
func (pls *PlayFc3d) zhixuanSum() bool {
	var lotNumsArr []string = strings.Split(pls.numLottery.LotNum, ",")
...
//组三单式
//格式为：2,2,3
func (pls *PlayFc3d) z3Single() bool {
	if strings.Count(pls.numLottery.LotNum, ",") != 2 {
		return false
	}
...
//组三复试
//格式为：1,2,3
func (pls *PlayFc3d) z3Complex() bool {
	var lotNumsArr []string = strings.Split(pls.numLottery.LotNum, ",")
	var ballNums = len(lotNumsArr)
...
func (pls *PlayFc3d) z6Single() bool {
...
//组六复试 -- 号码都不相同
func (pls *PlayFc3d) z6Complex() bool {
	if strings.Count(pls.numLottery.LotNum, ",") < 2 {
		return false
	}
	//投注数量
...
//组三组六和值
func (pls *PlayFc3d) z6z3Sum() bool {
	var lotNumsArr []string = strings.Split(pls.numLottery.LotNum, ",")
...
//前驱胆拖  胆【1】
//拖【2,9】
func (pls *PlayFc3d) zu3DanTuo() bool {
...
//组六胆拖验证
func (pls *PlayFc3d) zu6DanTuo() bool {
...
//组三 组六胆拖验证
func (pls *PlayFc3d) zuDanTuo(dantuo []int) (bool, []int) {
...
//排列组三组六和值 主要拆单
func (pls *PlayFc3d) GetNumLottery() []NumLottery {
...
//组三组六复试拆票
func (pls *PlayFc3d) z6z3SumSplite() []NumLottery {
	var betAll []NumLottery = make([]NumLottery, 0)
	var lotNumsArr []string = strings.Split(pls.numLottery.LotNum, ",")
	var ballNums int = len(lotNumsArr)
...
func NewPlayFc3d() LotteryInterface {
	return &PlayFc3d{}
}

func init() {
	Register("d3", NewPlayFc3d)
}
